...
/* 
  ...
  Preko linka stranica da se poziva fetch da ne bi na 
  razlicitim stranama prikazivao iste artikle

  const response = fetch("https://api/nesto")
...
*/
const sviArtikli = Array.from({ length: 43 }, (_, i) => ({
  id: i + 1,
