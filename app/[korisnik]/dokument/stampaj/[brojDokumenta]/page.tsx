...
const DokumentPage = () => {
  ...
  if (error) {
    return <div className="p-10 text-red-600">Greška: {error}</div>;
  }
  ...
  return (
    <div className="mx-auto bg-white text-black p-10 print:p-0">
      ...
      <div className="mt-10 w-full">
        ...
        <div className="flex justify-between gap-8 w-full mt-4">
          ...
          <div className="border border-black p-4 w-[48%]">
            ...
            <h3 className="mb-2 font-bold">{partnerInfo.ime || "Nepoznato"}</h3>
      ...
      <div className="mt-10 space-y-2">
        <p className="text-center">Isporučene količine mogu biti manje u zavisnosti od stanja na lageru</p>
        ...
        <div className="border border-black w-full mt-5">
          ...
          <div className="px-2 py-1 text-sm space-y-1">
            <p>
              <span>Korisničko ime:</span> {partnerInfo.komercijalisti?.id}
            </p>
            <p>
              <span>Ime i prezime:</span> {partnerInfo.komercijalisti?.naziv || "Nepoznato"}
            </p>
            <p>
              <span>Email adresa:</span> {partnerInfo.komercijalisti?.email}
            </p>
            <p>
              <span>Mob. telefon:</span> {partnerInfo.komercijalisti?.telefon}
            </p>
          </div>
        </div>
      </div>
